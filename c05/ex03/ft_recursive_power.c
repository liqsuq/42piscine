...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/10 20:29:18 by kadachi           #+#    #+#             */
/*   Updated: 2024/09/13 10:27:51 by kadachi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("    2,   24 => 16777216: %d\n", ft_recursive_power(    2,  24));
	printf(" 2999, -274 => 0       : %d\n", ft_recursive_power( 2999,-274));
	printf(" 3780,    0 => 1       : %d\n", ft_recursive_power( 3780,   0));
	printf("-2415,    1 => -2415   : %d\n", ft_recursive_power(-2415,   1));
	printf("    3,    2 => 9       : %d\n", ft_recursive_power(    3,   2));
